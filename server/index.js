import { c as create_ssr_component, s as setContext, v as validate_component, m as missing_component } from "./_app/immutable/chunks/index-de9f3fda.js";
...
const template = ({ head, body, assets: assets2, nonce }) => '<!DOCTYPE html>\n<html lang="en">\n	<head>\n		<meta charset="utf-8" />\n		<link rel="icon" href="' + assets2 + '/favicon.png" />\n		<script src="https://kit.fontawesome.com/3afb09b9ae.js" crossorigin="anonymous"><\/script>\n		<meta name="viewport" content="width=device-width" />\n		<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDmP0c1Exxs6w-8OiHzGO_B95R8u9M5bkY"><\/script>\n		' + head + '\n	</head>\n	<body class="font-sans">\n		<div class="bg-gray-100 h-screen h-full">' + body + "</div>\n	</body>\n</html>\n";
let read = null;
